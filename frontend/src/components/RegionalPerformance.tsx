    ...
    const loadRegionalData = async () => {
      try {
        ...
        if (!Array.isArray(result?.data)) {
          throw new Error(
            "Invalid regional performance response"
          );
        }

        const normalizedData: RegionData[] =
          result.data.map(
            (item: Partial<RegionData>) => ({
              region: String(
                item.region ?? "Unknown"
              ),
        ...
        console.error(
          "Regional Performance API error:",
          err
        );

        setError(
          "Unable to load regional performance from MetricMind backend."
        );
        ...
        <div style={styles.header}>
          ...
          <div>
            ...
            <p style={styles.subtitle}>
              Analyzing regional business performance
            </p>
      ...
      <div style={styles.container}>
        ...
        <div style={styles.header}>
          ...
          <div>
            ...
            <p style={styles.subtitle}>
              Regional business performance overview
            </p>
    ...
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        ...
        <div>
          ...
          <p style={styles.subtitle}>
            Review regional revenue, cost and profitability
          </p>
